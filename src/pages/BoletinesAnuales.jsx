      ...
      <header className="bg-white shadow-md">
        <div className="relative h-64 md:h-80 overflow-hidden">
          ...
          <div className="absolute bottom-0 left-0 right-0 max-w-7xl mx-auto px-4 py-6">
            <Link to="/" className="inline-flex items-center text-white hover:text-orange-200 mb-4">
            ...
            <p className="text-white/90 mt-2 text-lg">Consulta los boletines anuales por año</p>
          </div>
        </div>
      </header>
